pdf(file='S8A_c0_t1.pdf',width=4.5,height=4.5);
gstable=read.table('S8A_c0_t1.gene_summary.txt',header=T)
# 
#
# parameters
...
dev.off()
Sweave("S8A_c0_t1_summary.Rnw");
library(tools);

texi2dvi("S8A_c0_t1_summary.tex",pdf=TRUE);
